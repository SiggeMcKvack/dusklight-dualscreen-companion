...
void drawCompositeLayer(J2DPicture* src, f32 dx, f32 dy, f32 dw, f32 dh, u8 minAlpha) {
    ...
    s_iconPic->setCornerColor(JUtility::TColor(ga::cast(src)->getCornerColorRaw(0)),
        JUtility::TColor(ga::cast(src)->getCornerColorRaw(1)), JUtility::TColor(ga::cast(src)->getCornerColorRaw(2)),
...
void drawButtonCircleBase(dMeter2Draw_c* md, int xyIdx, f32 x, f32 y, f32 box) {
    J2DPicture* circle = ga::cast(md)->getButtonBasePicture(0);
    J2DPicture* tintSrc = ga::cast(md)->getButtonBasePicture(xyIdx);
    ...
    s_iconPic->setCornerColor(JUtility::TColor(ga::cast(tintSrc)->getCornerColorRaw(0)),
        JUtility::TColor(ga::cast(tintSrc)->getCornerColorRaw(1)),
        JUtility::TColor(ga::cast(tintSrc)->getCornerColorRaw(2)),
        JUtility::TColor(ga::cast(tintSrc)->getCornerColorRaw(3)));
